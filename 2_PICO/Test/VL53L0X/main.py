...
def map_i2c(value, old_min=0, old_max=2000, new_min=0, new_max=65535):
    # Can only pass bytes, so to transfer a number over two bytes, square root and send.
