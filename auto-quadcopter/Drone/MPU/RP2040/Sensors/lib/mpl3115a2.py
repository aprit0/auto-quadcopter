...
class MPL3115A2:
    ...
    **Quickstart: Importing and using the MPL3115A2**
    ...
    def __init__(self, i2c, *, address=_MPL3115A2_ADDRESS):
        ...
        try:
            while not self._poll_reg1(_MPL3115A2_CTRL_REG1_RST):
                pass
        except OSError:
            while not self._poll_reg1(_MPL3115A2_CTRL_REG1_RST):
                pass
    ...
    def _read_u8(self, address, count=1):
        # Read an 8-bit unsigned value from the specified 8-bit address.
        self._read_into(address, self._BUFFER, count=count)
    ...
    def _poll_reg1(self, mask):
        ...
        # present.
        if self._read_u8(_MPL3115A2_CTRL_REG1) & mask > 0:
            return False 
        return True
    ...
    def pressure(self):
        ...
        polled = self._poll_reg1(_MPL3115A2_CTRL_REG1_OST)
        if polled:
            ...
            out = self._read_u8(_MPL3115A2_REGISTER_STATUS) & _MPL3115A2_REGISTER_STATUS_PDR 
            if out == 0:
                return None
